...
See the [Hello Compute](https://github.com/charles-r-earp/autograph/tree/main/examples/hello-compute) example.
...
```
See the [KMeans Iris](https://github.com/charles-r-earp/autograph/tree/main/examples/kmeans-iris) example.
...
```
See the [Neural Network MNIST](https://github.com/charles-r-earp/autograph/tree/main/examples/neural-network-mnist) example.
...
See the [Neural Network](https://github.com/charles-r-earp/autograph/tree/main/benchmarks/neural-network) benchark.
